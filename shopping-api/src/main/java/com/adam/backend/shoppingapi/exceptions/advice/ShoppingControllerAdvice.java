package com.adam.backend.shoppingapi.exceptions.advice;

import com.adam.backend.shoppingapi.dtos.ErrorDTO;
...
@ControllerAdvice(basePackages = "com.adam.backend.shoppingapi.api")
